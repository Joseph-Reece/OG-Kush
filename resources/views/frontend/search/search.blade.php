                ...
                <div class="search-wrap">
                    ...
                    <div class="">
                        ...
                        <div class="row my-2">
                            ...
                            <select name="category_id" id="category" class="custom-select cat_id" onchange="GL_FILTER.ajaxFilterr()" >
                        ...
                        <div class="shop__meta">
                            <div class="site__search__form">
                                <div class="site__search__field">
                                    ...
                                    <input onkeyup="doSearch()" class="site__search__input" type="text" id="keyword" name="keyword"  placeholder="{{__('Search')}}">
